...
from z_pos.common._CONTS import Consts
from z_pos.common._URL_CONSTS import UrlConsts
...
class WindowClass(QMainWindow, form_class):
    def __init__(self):
        ...
        # 입력창 변경(입력)시 연결하는 코드
        self.line_coupon_num.textChanged.connect(self.lineeditTextFunction)  # 
        self.line_exchange_id.textChanged.connect(self.lineeditTextFunction)  # 
        self.line_branch_name.textChanged.connect(self.lineeditTextFunction)  # 
        self.line_branch_code.textChanged.connect(self.lineeditTextFunction)  # 
        self.line_pos_code.textChanged.connect(self.lineeditTextFunction)  # 
        self.line_coupon_use_amt.textChanged.connect(self.lineeditTextFunction)  # 
        self.line_admit_num.textChanged.connect(self.lineeditTextFunction)  # 
    ...
    def initUI(self):
        ...
        elif self.HOST in Consts.ServiceMode.PROD_HOST:
